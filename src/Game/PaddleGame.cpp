    ...
    void PaddleGame::Initialize()
    {
        ...
        for (auto playerEntity : FindEntities(Generated::EntityType::Paddle))
        {
            _collisionSystem.AddCollisionCallback(playerEntity,
                                                  ...
                                                  std::bind(&Paddle::OnViewportCollision, &_paddles,
                                                            std::placeholders::_1));
        }
        ...
        for (auto ballEntity : FindEntities(Generated::EntityType::Ball))
        {
            _collisionSystem.AddCollisionCallback(ballEntity,
                                                  ...
                                                  std::bind(&Ball::OnBlockCollision, &_ball,
                                                            std::placeholders::_1));
            _collisionSystem.AddCollisionCallback(ballEntity,
            ...
            _collisionSystem.AddCollisionCallback(ballEntity,
                                                  Generated::EntityType::ViewportContainer,
                                                  std::bind(&Ball::OnViewportCollision, &_ball,
                                                            std::placeholders::_1));
        }

        _inputHandler.OnGamepadEvent(Engine::Input::GamepadCode::GamepadLeftAxis, std::bind(&Paddle::MoveLeft, &_paddles, std::placeholders::_1));
        _inputHandler.OnGamepadEvent(Engine::Input::GamepadCode::GamepadRightAxis, std::bind(&Paddle::MoveRight, &_paddles, std::placeholders::_1));
        _inputHandler.OnGamepadEvent(Engine::Input::GamepadCode::GamepadButtonA, std::bind(&Paddle::LaunchBall, &_paddles, std::placeholders::_1));
        _inputHandler.OnGamepadEvent(Engine::Input::GamepadCode::GamepadButtonB, std::bind(&Paddle::DebugAttachBall, &_paddles, std::placeholders::_1));
    }
